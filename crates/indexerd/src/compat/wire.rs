// Copied verbatim (with two import adaptations) from starkware-libs/starknet-privacy
// crates/discovery-service/src/api/types.rs @ tag CONTRACT_V2_DEPLOYED_MAINNET_2026-07-08
// (commit 74841caf). Apache-2.0. Byte-exact wire compatibility depends on this file;
// do not edit field order or serde attributes.
...
use crate::compat::block_id_serde;
use crate::compat::ChainHead;
