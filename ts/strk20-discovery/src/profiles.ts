...
export function resolveProfile(n: 'mainnet' | 'sepolia' | ChainProfile | undefined): ChainProfile {
  if (n === undefined || n === 'mainnet') return MAINNET;
  if (n === 'sepolia') return SEPOLIA;
  if (typeof n === 'object' && typeof n.chainId === 'string' && typeof n.pool === 'string') return n;
