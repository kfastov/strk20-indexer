...
export const NETWORKS = {
  mainnet: {
    ...
    rpc: import.meta.env?.VITE_MAINNET_RPC_URL || "https://starknet.publicnode.com",
    ws: import.meta.env?.VITE_MAINNET_RPC_WS_URL || "wss://starknet-rpc.publicnode.com",
    proofRpc: import.meta.env?.VITE_MAINNET_RPC_URL || "https://api.cartridge.gg/x/starknet/mainnet",
  ...
  sepolia: {
    ...
    rpc: import.meta.env?.VITE_SEPOLIA_RPC_URL || "https://starknet-sepolia-rpc.publicnode.com",
    ws: import.meta.env?.VITE_SEPOLIA_RPC_WS_URL || "wss://starknet-sepolia-rpc.publicnode.com",
    proofRpc: import.meta.env?.VITE_SEPOLIA_RPC_URL || "https://api.cartridge.gg/x/starknet/sepolia",
